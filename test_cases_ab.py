...
rsa_key4, public_key4 = generate_key_pair()
...
send_and_receive_message('k', public_key4, 0, 4, rsa_key4, public_key4)

guard = "guard2\n> tcp.src_port 10\n< tcp.dst_port 5\nAND ^0 ^1"
send_and_receive_message('i', guard, 1, 2, rsa_key2, public_key2)
guard = "guard3\n> tcp.dst_port 10\n< tcp.src_port 5\nAND ^0 ^1"
send_and_receive_message('i', guard, 1, 3, rsa_key3, public_key3)

guard = "guard1 102 103\n> tcp.src_port 10\n> tcp.dst_port 10\n= ip.ver 6\nAND ^0 ^1\nAND ^2 ^3"
send_and_receive_message('i', guard, 1, 1, rsa_key1, public_key1)

receive_permissions_message(2)
send_and_receive_message('a', '101 guard1', 2, 2, rsa_key2, public_key2)

receive_permissions_message(3)
send_and_receive_message('d', '101 guard1', 2, 3, rsa_key3, public_key3)

receive_permissions_message(1)

# guard = "guard4\n= tcp.src_port 8\n= tcp.dst_port 8\n= ip.ver 6\nAND ^0 ^1\nAND ^2 ^3"
# send_and_receive_message('i', guard, 3, 4, rsa_key4, public_key4)

send_and_receive_message('n', '101', 4, 1, rsa_key1, public_key1)
send_and_receive_message('g', '101 guard1', 5, 1, rsa_key1, public_key1)
